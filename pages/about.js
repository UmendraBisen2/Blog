  ...
  return (
    <div className="min-h-screen relative bg-white dark:bg-gray-900">
      ...
      <div className="max-w-2xl pt-20 pb-32 px-6 text-center mx-auto">
        ...
        I am Umendra Anjilal Bisen. I am from Nagpur. I am  pursuing my Engineering form Priyadarshini College of Engineering Nagpur in specialization  Electrical Engineering .  My strength is I am creative person, quick learner & passionate about work. I have experience of internship  in Revat Network , CodeSof IT services , Cognifyz Technologies and  and  Engineering India  coordinator and  Training and Placement - Forum Member-PCE , GDSC Member , GDG Member.
        ...
        <div className="text-center pt-8">
          <button className="bg-indigo-500 px-3 py-1 font-semibold text-white inline-flex items-center space-x-2 rounded dark:bg-indigo-600">
            ...
            <a
              ...
              target="_blank"
              href="https://umendra-portfolio-hedj.vercel.app/"
            >
              See My Works
            </a>
          </button>
